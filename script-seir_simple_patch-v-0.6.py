...
#if (os.environ['HOME'] == ""):
#data_project_folder='projects/chik-caribbean/'
data_project_folder='Sript-data/'
#else:
#    data_project_folder='projects/chik-caribbean/'
...
init_bound = 0.8  # for building an interval around the intial value
param_partition = 10.0  # number of points that divide the interval
numberof_recurrences = 2 # number of iterations for the least square fitting
...
#my_observed_chik_plot  = f_plot_observed_chik(data_project_folder)
...
pl.plot(my_model_ts)
pl.title('Model fitting -least squares- beta=%f, sigma=%f gamma=%f,' %(beta, sigma, gamma))
pl.ylabel("Number of infecteds", size=15, **sefont)
pl.xlabel("Time",size=15, **sefont)
pl.savefig('./figures/FITTED_AGGREGATED_MODEL_experiment=%f_beta=%f_sigma=%f_gamma=%f_param_partition=%f_init_bound=%f.png'
           %(experiment, beta, sigma, gamma, param_partition, init_bound), dpi=400)
#pl.show()
#
#
################################...###############################################
...
#
#
## function: ode_solver(Y0_node, t, beta, sigma, gamma)
